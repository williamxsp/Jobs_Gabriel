    ...
    $.jSlots = function(el, options){
        ...
        base.Slot.prototype = {
            ...
            finish : function() {
                ...
                var endNum = sorteio[id];
                /*
                    com o id já identifico qual roleta está terminando de rodar
                    daí é só setar a variável endNum para o número desejado e manipular o sorteio =)
*/    

                // var endNum = Math.random() > 0.5 ? 1 : 6;
